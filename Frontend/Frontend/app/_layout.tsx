...
export default function Layout() {
  return (
    <Stack>
      ...
      <Stack.Screen
        name="pages/Map"
        options={{ title: "View Map", gestureEnabled: false, headerShown: false  }}
      />
      <Stack.Screen
        name="pages/RegisterPage"
        options={{ title: "Register", gestureEnabled: false, headerShown: false }} />
      <Stack.Screen
        name="pages/Profile"
        options={{ title: "Profile", gestureEnabled: false, headerShown: false }} />
    </Stack>
